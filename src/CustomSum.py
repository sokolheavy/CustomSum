...
with app_header:
    ...
    st.markdown("##### [GitHub repo](https://github.com/sokolheavy/CustomSum)")
    st.warning("🚧️ This app is still in beta. Please [report any bugs](https://github.com/sokolheavy/CustomSum/issues) to the GitHub repo.")
